...
<body>
    ...
    <main>
        ...
        <form  method="post" action="supprimer_voiture1.php">
            <label for="immat_a_supp">Entere L'immatriculation de voiture à supprimer : </label>
            <input type="text" name="immat_a_supp" placeholder=" immatriculation de voiture..." required>
            <section>
