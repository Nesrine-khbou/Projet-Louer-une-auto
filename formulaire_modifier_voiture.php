...
<body>
    ...
    <main>
        <div id="space"></div>
        <form  method="post" action="modifier_voiture1.php">
            <label for="immat_a_modifier">Entere L'immatriculation de voiture à modifier : </label>
            <input type="text" name="immat_a_modifier" placeholder=" immatriculation de voiture..." required>
            <section>
