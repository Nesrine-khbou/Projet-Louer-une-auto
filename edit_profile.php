    ...
    <main>
                ...
                <section id=\"profile\">
                    ...
                    <section id=\"profile_pic\">
                        ...
                        <ul id=\"edit_pic\">
                            ...
                            <li>
                                <ul>
                                    <li> <label>Modifier photo</label> </li>
                                    <li><input type=\"file\" name=\"name_img\"></li>
                                </ul>
                            </li>
                        </ul>
                    </section>
                    <section id=\"profile_data\">
                            <ul class=\"inline_2\">
                                <li>
                                    ...
                                    <input type=\"text\" name=\"lname\"  value=".$client[0]->Nom.">
                                </li>
                                <li>
                                    <label for=\"name\">Prenom</label>
                                    <input type=\"text\" name=\"name\"  value=".$client[0]->Prenom.">
                                </li>
                            </ul>
                            <ul class=\"inline_2\">
                                <li>
                                    <label for=\"adress\">Localite</label>
                                    <input type=\"text\" name=\"adress\"  value=".$client[0]->localite.">
                                </li>
                                <li>
                                    <label for=\"codepostal\">Code Postal </label>
                                    <input type=\"number\" name=\"codepostal\"  value=".$client[0]->CodePostal.">
                                </li>
                            </ul>
                            <ul class=\"inline_2\">
                                <li>
                                    <label for=\"email\">Email</label>
                                    <input type=\"email\" name=\"email\"  value=".$client[0]->Email.">
                                </li>
                            </ul>
                            <ul class=\"inline_2\">
                                <li>
                                    ...
                                    <div id=\"telephone_input\">
                                        <input id=\"preTel\" type=\"text\" name=\"preTelephone\"  value=\"+216\">
                                        <input id=\"tel\" type=\"text\" name=\"Telephone\"  value=".$client[0]->telephone.">
                                    </div>
                                </li>
                                <li>
                                    <label for=\"mot_de_passe\">Mot De Passe</label>
                                    <input type=\"text\" name=\"mot_de_passe\"  value=".$client[0]->mot_de_passe.">
                                </li>
                            </ul>
                            <ul id=\"edit_save\">
                                <li><button  id=\"edit\" name=\"enregistrer\">Enregistrer</button></li>
                            </ul>
                        </li>
                    </ul>
        ...
        if(isset($_POST["enregistrer"])){
            ...
            echo "une erreur s'est produite";
                ...
                copy($_FILES['name_img']['tmp_name'],"pics/".$new_name);

                $sql="update clients set Nom='$lname' , Prenom='$namec' , CodePostal='$codepostal', localite='$adress', telephone='$Telephone',Email='$email', imgClient='$new_name',mot_de_passe='$mot_de_passe'  where Email='".($_SESSION['email'])."' and mot_de_passe='".($_SESSION['mdp'])."'";
                $cnx->exec($sql);
            }
        }    
    ?>
